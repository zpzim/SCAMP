...
macro(mark_cuda_if_available)
  get_property(current_targets DIRECTORY ${dir} PROPERTY BUILDSYSTEM_TARGETS)
  if (CMAKE_CUDA_COMPILER OR USE_HIP)
    foreach(lib ${current_targets})
      target_compile_definitions("${lib}" PUBLIC -D_HAS_CUDA_)
      if(USE_HIP)
        target_compile_definitions("${lib}" PUBLIC -DUSE_HIP)
      endif()
    endforeach(lib)
  endif()
endmacro()
...
macro(set_cuda_architectures)
  ...
  # Check if a custom architecture has been specified via environment variable or CMake command line.
  # Otherwise, fallback to the default dynamic architecture list.
  if (DEFINED ENV{CMAKE_CUDA_ARCHITECTURES})
    set(CMAKE_CUDA_ARCHITECTURES "$ENV{CMAKE_CUDA_ARCHITECTURES}")
  elseif (DEFINED USER_SPECIFIED_CUDA_ARCHITECTURES)
    set(CMAKE_CUDA_ARCHITECTURES ${USER_SPECIFIED_CUDA_ARCHITECTURES})
  else()
