...
enum SCRIMPError_t { SCRIMP_NO_ERROR, SCRIMP_FUNCTIONALITY_UNIMPLEMENTED, SCRIMP_TILE_ILLEGAL_TYPE, SCRIMP_CUDA_ERROR, SCRIMP_CUFFT_ERROR, SCRIMP_CUFFT_EXEC_ERROR, SCRIMP_INCVALID_TYPE };

enum SCRIMPTileType { SELF_JOIN_FULL_TILE, SELF_JOIN_UPPER_TRIANGULAR, AB_JOIN_FULL_TILE, AB_JOIN_UPPER_TRIANGULAR, AB_JOIN_LOWER_TRIANGULAR };
